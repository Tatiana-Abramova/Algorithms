...
import static algo.task_03_bits.BitKnight.calcPossibleMoves;

public class BitKnightTest extends BaseTest{
    private static final String PATH = BaseTest.ROOT_DATA_PATH + "/task_03_bits/0.BITS/2.Bitboard - Конь";
